...
export const CORPUS: ReadonlyArray<string> = [
    ...
    "Engineering shipped 14 new features this quarter, including the livetrace public API, the cross-region failover for our queue subsystem, and the long-awaited rebuild of the importer pipeline.",
    ...
    "Open-source - we extracted livetrace as a standalone npm package under Apache-2.0. Initial signups crossed 412 within 48 hours of launch. Two early adopters are already integrating against the SSE transport.",
